ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :employees, :collection => {:people => :get, :new_recruit => :get, :new_bulk => :get, :recruit => :post, :invitation => :get, :company_department => :get, :check_email_name => :get}
  ...
  map.namespace :api do |api|
    ...
    api.namespace :v2 do |v2|
      ...
      v2.resources :employees, :only => [:index], :collection => {:create_success => :get, :create_fail => :get, :login_fail => :get}
  ...
  map.resources :users, :member => {:contacts => :get, :friends => :get, :friendship_request => :get, :friendship_delete => :get, :remove_mt_association => :put, :addippbx => :get, :removeippbx => :get, :client_configuration => :get,:terms => :get, :service_terms=>:get, :services => :get, :payments => :get,:thanks=>:get, :payment_requests => :get, :generate_user_payment_requests => :put}, :collection => {:confirmation=>:get, :spiceworks => :get, :payment_thanks => :post, :linkedin_signup => :get, :linkedin_signin => :get} do |user|
    ...
    user.resources :applications, :only => [:index, :show], :collection => {:company_catalog => :get, :my_applications => :get}, :member => {:send_bin_file => :get,:bin_file_download => :get, :assign_employees_or_departments => :post, :send_request => :put, :send_employee_request => :put, :add_user_ippbx => :put, :remove_user_ippbx => :put, :send_cancel_request => :put, :remove_application => :put, :download_application => :get,:download_link => :get, :send_download_link => :get, :device_bin_file_download => :get}
    user.resources :orders, :collection =>{:track_order => :get,:payments => :get, :cart => :get, :wish_list => :get, :checkout_whishlist=>:get}, :member => {:create_app_order => :put }
    ...
    user.resources :friendships, :member => {:accept => :get, :reject => :get}, :collection => {:accept_all => :post, :reject_all => :post, :resend_all => :post, :destroy_all => :post, :incoming_requests => :get, :outcoming_requests => :get, :rejected_outcoming_requests => :get}
  ...
  map.resources :company_stats,:member => {:cost_trend_app => :get, :cost_trend_department => :get, :top_apps_cost => :get, :top_department_cost => :get, :top_employee_cost => :get, :app_seats_report => :get, :cost_apps_user => :get} do |company_stat|
  end
   
  map.resources :companies, :member => {:profile => :get, :addippbx => :get, :removeippbx => :get, :stats => :get} do |company|
    company.resources :employees, :member => {:invite => :get, :edit_by_employee => :get, :update_by_employee => :put, :sogo_connect => :get, :devices => :get, :update_devices => :put}, :collection => {:invite_all => :post, :destroy_all => :post, :activate_all => :post, :new_bulk => :get, :bulk_create => :post}
    company.resources :departments, :member => {:edit_by_department => :get, :update_by_department => :put},  :collection => {:destroy_all => :post}
    company.resources :application_requests, :only => [:index], :member => {:approve => :put, :reject => :put, :resend_company_request => :put, :resend_employee_request => :put}, :collection => {:incoming_employee_requests => :get, :employee_requests => :get}
    company.resources :company_applications, :member => {:add_downloadable_apps => :get, :update_downloadable_apps => :put, :remove_downloadable_apps => :get, :delete_downloadable_apps => :put, :create_plan => :put, :list_plan =>:get, :new_plan =>:get, :edit_plan =>:get, :update_plan => :put, :delete_plan => :put}
  end
