...
class SignatureUtilsForOutbound < ApplicationController
  ...
  USER_AGENT_STRING = "ASPSubscription-RUBY-2.0-2010-09-13"
  ...
  def validate_signature_v2(args)
    ...
    SignatureUtilsForOutbound::urlencode(SignatureUtilsForOutbound::get_http_params(parameters))
				 ...
				 logger.info "verify_signature_request #{verify_signature_request}"
  ...
  def self.get_http_data(url)
    ...
    http_session.ca_file = '/etc/ssl/ca-bundle.crt'
